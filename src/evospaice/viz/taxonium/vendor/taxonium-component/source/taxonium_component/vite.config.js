// Modified by the Evospaice project on 2026-09-16 to add a distribution notice.
...
export default defineConfig({
  ...
  build: {
    ...
    rollupOptions: {
      ...
      output: {
        banner:
          "/*! Modified Taxonium component, GPL-3.0-only. " +
          "Modified by Evospaice on 2026-09-16. " +
          "License: ./LICENSE. Corresponding source: ./source/ */",
